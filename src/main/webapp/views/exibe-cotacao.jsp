...
<body>
	...
	<form:form class="form-horizontal" method="post" action="/despesa/util/cotacao" modelAttribute="cotacao">
		<div class="card">
			<div class="card-header">
				<div class="clearfix">
	   				<h4 class="card-title impacta-titulo-panel"> Consulta Cotação
			...
			<div class="card-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<form:input disabled="true" class="form-control javascript-moeda" path="precoVenda"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<form:input disabled="true" class="form-control javascript-moeda" path="precoCompra"/>
					</div>
				</div>
